...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="backassets/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    ...
    <section class="content">
      ...
      <div class="card card-primary">
              ...
              <form role="form" action="updateportfolio.php" method="POST" enctype="multipart/form-data">
                ...
                <img src="upload/<?php echo $data['image']; ?>" width="100px">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                        <span class="input-group-text" id="">Update</span>
                      </div>
